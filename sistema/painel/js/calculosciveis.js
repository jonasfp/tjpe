$(document).ready(function(){
   ...
   $('#datafinaljuros').change(function() {
     ...
     while(count>=2){
        ...
        $('#total1'+count).val(totallinha.toFixed(2))
...
$('#total1'+count).prop('readonly', true);
...
function somaparcial(){
    ...
    while(contador>1){            
        ...
        soma += parseFloat($('#total1'+contador).val())
    ...
    var somatotal = soma+parseFloat($('#total1').val())
...
$('#datafinaljuros').change(function() {
    ...
    if (start<end) {
        ...
        var totallinha = indice*(1+juros)*valor
        $('#total1').val(totallinha.toFixed(2))
        var soma = $('#total1').val()
